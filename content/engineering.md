...
AIに任せる範囲は、実力に合わせて広げてきました。難しいコンポーネントの実装、PoCによる実現可能性の検証、未知の技術領域のキャッチアップ、そして動作確認まで。一方で、重要な設計と、その意味が実装に表れているかを確認する責任は、自分が担うものだと考えています。

### 業務の意味と実装が一致するかは、人が見届ける

生成AIでコードを書くことが容易になっても、重要な機能の設計と、その意図が実装に表れているかの確認は、人が担う必要があります。日本語で説明した業務ルールが、実際にはどの条件や処理になっているのか。設計者として、その対応を自分の目で確かめるべきコードが必ずあります。
