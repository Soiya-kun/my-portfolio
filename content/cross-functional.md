...
顧客折衝の約9割は自ら担い、仕様の相談、問題のヒアリング、スケジュール調整、要求のすり合わせを行ってきました。顧客と話した内容をそのまま設計・実装の判断につなげられることが、両方の役割を担う強みです。
...
設計の大部分を自ら担っていたため、その意図を実装へ直接つなげられました。AIを活用しながら開発を進め、3案件の並行開発を乗り切っています。新しい技術の可能性を自分で試し、顧客への提案から実装まで担った経験です。
